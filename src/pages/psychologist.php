                ...
                <div class="main-content">
                    ...
                    <div class="question-area">
                        ...
                        <div class="question-main">
                            <div class="label">
                                <form method="POST" action="../src/php/focuses/add_psycho.php">
                                    <div class="form-group">
                                        <label for="username">Ваша фамилия<span class=""></span></label>
                                        <input type="text" id="username" class="form-control" name="surname">
                                    </div>
                                    <div class="form-group">
                                        <label for="usersurname">Ваше имя<span class=""></span></label>
                                        <input type="text" id="usersurname" class="form-control" name="name">
                                    </div>
                                    <div class="form-group">
                                        <label for="usersecondname">Ваше отчество<span class=""></span></label>
                                        <input type="text" id="usersecondname" class="form-control" name="patronim">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="theme">Тема<span class=""></span></label>
                                        <input type="text" id="theme" class="form-control" type="email" name="title">
                                    </div>
                                    <div class="form-group">
